...
<html lang="es">
	...
	<body class="menubar-hoverable header-fixed menubar-pin menubar-first">
							...
							<ul class="dropdown-menu animation-expand">
								...
								<li>
									<a class="alert alert-callout alert-warning" href="javascript:void(0);">
										<img class="pull-right img-circle dropdown-avatar" src="${resourcesMaterial}/img/avatar2.jpg" alt="" />
								...
								<li>
									<a class="alert alert-callout alert-info" href="javascript:void(0);">
										<img class="pull-right img-circle dropdown-avatar" src="${resourcesMaterial}/img/avatar3.jpg" alt="" />
										<strong>Alicia Adell</strong><br/>
										<small>Reviewing last changes...</small>
									</a>
								</li>
								<li class="dropdown-header">Options</li>
								<li><a href="login.jsp">View all messages <span class="pull-right"><i class="fa fa-arrow-right"></i></span></a></li>
								<li><a href="login.jsp">Mark as read <span class="pull-right"><i class="fa fa-arrow-right"></i></span></a></li>
					...
					<ul class="header-nav header-nav-profile">
						<li class="dropdown">
							<a href="javascript:void(0);" class="dropdown-toggle ink-reaction" data-toggle="dropdown">
								<img src="${resourcesMaterial}/img/avatar1.jpg" alt="" />
						...
						<ul class="list ">
							...
							<li class="tile">
								<a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
									<div class="tile-icon">
										<img src="${resourcesMaterial}/img/avatar4.jpg?1404026791" alt="" />
									</div>
									<div class="tile-text">
										Alex Nelson
							...
							<li class="tile">
								<a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
									<div class="tile-icon">
										<img src="${resourcesMaterial}/img/avatar9.jpg?1404026744" alt="" />
									</div>
									<div class="tile-text">
										Ann Laurens
										<small>123-123-3210</small>
							...
							<li class="tile">
								<a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
									<div class="tile-icon">
										<img src="${resourcesMaterial}/img/avatar2.jpg?1404026449" alt="" />
									</div>
									<div class="tile-text">
										Jessica Cruise
										<small>123-123-3210</small>
							...
							<li class="tile">
								<a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
									<div class="tile-icon">
										<img src="${resourcesMaterial}/img/avatar8.jpg?1404026729" alt="" />
									</div>
									<div class="tile-text">
										Jim Peters
										<small>123-123-3210</small>
							...
							<li class="tile">
								<a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
									<div class="tile-icon">
										<img src="${resourcesMaterial}/img/avatar5.jpg?1404026513" alt="" />
									</div>
									<div class="tile-text">
										Mabel Logan
										<small>123-123-3210</small>
							...
							<li class="tile">
								<a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
									<div class="tile-icon">
										<img src="${resourcesMaterial}/img/avatar11.jpg?1404026774" alt="" />
									</div>
									<div class="tile-text">
										Mary Peterson
										<small>123-123-3210</small>
							...
							<li class="tile">
								<a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
									<div class="tile-icon">
										<img src="${resourcesMaterial}/img/avatar3.jpg?1404026799" alt="" />
									</div>
									<div class="tile-text">
										Mike Alba
										<small>123-123-3210</small>
							...
							<li class="tile">
								<a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
									<div class="tile-icon">
										<img src="${resourcesMaterial}/img/avatar6.jpg?1404026572" alt="" />
									</div>
									<div class="tile-text">
										Nathan Peterson
										<small>123-123-3210</small>
							...
							<li class="tile">
								<a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
									<div class="tile-icon">
										<img src="${resourcesMaterial}/img/avatar7.jpg?1404026721" alt="" />
									</div>
									<div class="tile-text">
										Philip Ericsson
										<small>123-123-3210</small>
							...
							<li class="tile">
								<a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
									<div class="tile-icon">
										<img src="${resourcesMaterial}/img/avatar10.jpg?1404026762" alt="" />
									</div>
									<div class="tile-text">
										Samuel Parsons
										<small>123-123-3210</small>
				...
				<div id="offcanvas-chat" class="offcanvas-pane style-default-light width-12">
					...
					<div class="offcanvas-body">
						<ul class="list-chats">
							<li>
								<div class="chat">
									<div class="chat-avatar"><img class="img-circle" src="${resourcesMaterial}/img/avatar1.jpg?1403934956" alt="" /></div>
									<div class="chat-body">
							...
							<li class="chat-left">
								<div class="chat">
									<div class="chat-avatar"><img class="img-circle" src="${resourcesMaterial}/img/avatar9.jpg?1404026744" alt="" /></div>
									<div class="chat-body">
							...
							<li>
								<div class="chat">
									<div class="chat-avatar"><img class="img-circle" src="${resourcesMaterial}/materialAdmin/assets/img/avatar1.jpg?1403934956" alt="" /></div>
									<div class="chat-body">
		...
		<!-- BEGIN JAVASCRIPT -->
		<script src="${resourcesMaterial}/js/libs/jquery/jquery-1.11.2.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/jquery/jquery-migrate-1.2.1.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/bootstrap/bootstrap.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/spin.js/spin.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/autosize/jquery.autosize.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/moment/moment.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/flot/jquery.flot.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/flot/jquery.flot.time.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/flot/jquery.flot.resize.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/flot/jquery.flot.orderBars.js"></script>
		<script src="${resourcesMaterial}/js/libs/flot/jquery.flot.pie.js"></script>
		<script src="${resourcesMaterial}/js/libs/flot/curvedLines.js"></script>
		<script src="${resourcesMaterial}/js/libs/jquery-knob/jquery.knob.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/sparkline/jquery.sparkline.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/nanoscroller/jquery.nanoscroller.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/d3/d3.min.js"></script>
		<script src="${resourcesMaterial}/js/libs/d3/d3.v3.js"></script>
		<script src="${resourcesMaterial}/js/libs/rickshaw/rickshaw.min.js"></script>
		<script src="${resourcesMaterial}/js/core/source/App.js"></script>
		<script src="${resourcesMaterial}/js/core/source/AppNavigation.js"></script>
		<script src="${resourcesMaterial}/js/core/source/AppOffcanvas.js"></script>
		<script src="${resourcesMaterial}/js/core/source/AppCard.js"></script>
		<script src="${resourcesMaterial}/js/core/source/AppForm.js"></script>
		<script src="${resourcesMaterial}/js/core/source/AppNavSearch.js"></script>
		<script src="${resourcesMaterial}/js/core/source/AppVendor.js"></script>
		<!-- END JAVASCRIPT -->
